export default [
    {
        ...
        description:"A social media app for movie lovers powered by the IMDB API. Allows users to find movies, write reviews, leave comments, and make friends!",
    ...
    },
    {
        ...
        description:"Personal website with blogging capabilities. Auth and backend handled by Firebase.",
    ...
    },
    {
        ...
        description:"A nutrition guide leveraging the spoonacular API.",
    ...
    },
    {
        ...
        description:"Data analysis for a hypothetical music festival",
        skills: ["Python", "SQL"]
    },
